...
* .NET 6.0, .NET 8.0 - 10.0

The library can be used in WPF and Windows Forms applications.

### For the Library
The library can be downloaded from the following sources
* **NuGet (WPF Only Package)**, [Version 1.8.6 - SharpVectors.Wpf](https://www.nuget.org/packages/SharpVectors.Wpf/).
* **NuGet (Full Package - WPF/GDI++)**, [Version 1.8.6 - SharpVectors](https://www.nuget.org/packages/SharpVectors/).
* **NuGet (Full Package - WPF/GDI++)**, [Version 1.8.6 - SharpVectors.Reloaded](https://www.nuget.org/packages/SharpVectors.Reloaded/).
* **GitHub Releases Page**, [Version 1.8.6](https://github.com/ElinamLLC/SharpVectors/releases).
